...
## 校正根拠の記述例（すべて日本語）
- 「IEEE論文形式ガイド ナレッジ『現在完了時制は研究の継続性を示す場合に使用』に基づく修正」
- 「学術英語スタイルガイド ナレッジ『受動態は客観性を保つため結果報告で推奨』に基づく修正」
- 「論文執筆マニュアル ナレッジ『図表参照は"Figure 1 shows"ではなく"as shown in Figure 1"が適切』に基づく修正」
...
## 校正根拠記述形式
各修正に対して以下の形式で**日本語**の根拠を明記してください：
