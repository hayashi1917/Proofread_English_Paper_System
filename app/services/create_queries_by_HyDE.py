...
3. その知識を検索するための**日本語の具体的キーワード**を生成

## 重要な制約
- **言語統一**: ナレッジベースが日本語のため、検索クエリは必ず日本語で出力
- **検索効率**: 日本語クエリにより知識ベースとの言語的一致を確保
"""
...
## 出力要求
上記観点で分析し、実際に改善が必要な項目を**日本語の具体的なキーワード・フレーズ**で出力してください。

**重要**: ナレッジベースが日本語で構成されているため、検索クエリは必ず日本語で出力すること。
...
**日本語のナレッジベース検索用クエリ**として出力してください。

**注意**: 出力するクエリは必ず日本語で記述し、英語での出力は避けてください。
"""
